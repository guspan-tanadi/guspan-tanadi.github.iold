...
![Ilustrasi Chatbot](/images/frontpost1.png "Ilustrasi Percakapan Sistem dengan Pengguna")
...
Bilang saja bahwa komponen utama pada chatbot tentu mesin _chat_ yang dituntut agar mampu mengartikan kalimat masukan (_input_) lalu menyerahkan jawaban (_output_) pada pengguna. Sebuah [NLP](https://connect.aricent.com/2017/10/10-questions-answers-about-chatbots).
...
![Bentuk Tanggapan](/images/hire.png "Contoh Tanggapan")
